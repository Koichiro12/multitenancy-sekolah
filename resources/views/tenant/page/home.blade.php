        ...
        <div class="home__mitra">
            ...
            <div class="home__mitra--wrapper">
                <div class="home__mitra--wrapper__box">
                    <img src="{{ 'public/tenant/img/brand/logoPgri.png' }}" alt="" />
                </div>
                <div class="home__mitra--wrapper__box">
                    <img src="{{ 'public/tenant/img/brand/logoNu.png' }}" alt="" />
                </div>
                ...
                <div class="home__berita-container">
                    <a href="{{ route('detailNews') }}" class="berita-box">
                        ...
                        <div class="berita-box-img"
                            style="background: url({{ 'public/tenant/img/berita/berita1.jpg' }})"></div>
                        <div class="berita-box-info">
                            <div class="berita-box-info-title">
                    ...
                    <a href="{{ route('detailNews') }}" class="berita-box">
                        ...
                        <div class="berita-box-img"
                            style="background: url({{ 'public/tenant/img/berita/berita2.jpg' }})"></div>
                        <div class="berita-box-info">
                            <div class="berita-box-info-title">
                                <div class="berita-box-info-title-cat">berita</div>
                                <div class="berita-box-info-title-txt">Illiyin Studio Developer</div>
                    ...
                    <a href="{{ route('detailNews') }}" class="berita-box">
                        ...
                        <div class="berita-box-img"
                            style="background: url({{ 'public/tenant/img/berita/berita3.jpg' }})"></div>
                        <div class="berita-box-info">
                            <div class="berita-box-info-title">
                                <div class="berita-box-info-title-cat">berita</div>
                                <div class="berita-box-info-title-txt">Illiyin Studio Developer</div>
                    ...
                    <a href="{{ route('detailNews') }}" class="berita-box">
                        ...
                        <div class="berita-box-img"
                            style="background: url({{ 'public/tenant/img/berita/berita4.jpg' }})"></div>
                        <div class="berita-box-info">
                            <div class="berita-box-info-title">
                                <div class="berita-box-info-title-cat">berita</div>
                                <div class="berita-box-info-title-txt">Illiyin Studio Developer</div>
                    ...
                    <a href="{{ route('detailNews') }}" class="berita-box">
                        ...
                        <div class="berita-box-img"
                            style="background: url({{ 'public/tenant/img/berita/berita5.jpg' }})"></div>
                        <div class="berita-box-info">
                            <div class="berita-box-info-title">
                                <div class="berita-box-info-title-cat">berita</div>
                                <div class="berita-box-info-title-txt">Illiyin Studio Developer</div>
