    ...
    <ul class="menu-inner py-1">
        ...
        <li class="menu-item">
            <a href="javascript:void(0);" class="menu-link menu-toggle">
                ...
                <div data-i18n="Account Settings">Infrastruktur</div>
            </a>
            <ul class="menu-sub">
                <li class="menu-item">
        ...
        <li class="menu-item">
            <a href="javascript:void(0);" class="menu-link menu-toggle">
                ...
                <div data-i18n="Authentications">Berita & Artikel</div>
            </a>
            <ul class="menu-sub">
                <li class="menu-item">
                    <a href="{{ route('dashboardBerita') }}" class="menu-link">
        ...
        <li class="menu-item">
            <a href="javascript:void(0)" class="menu-link menu-toggle">
                ...
                <div data-i18n="User interface">Permission And Role</div>
            </a>
            <ul class="menu-sub">
                <li class="menu-item">
                    <a href="" class="menu-link">
                        <div data-i18n="Accordion">Permission</div>
                    </a>
                </li>
                <li class="menu-item">
                    <a href="" class="menu-link">
