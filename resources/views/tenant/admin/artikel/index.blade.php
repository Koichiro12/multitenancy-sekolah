        ...
        <div class="card mb-4">
            <div class="card-header">
                <div class="row">
                    ...
                    <div class="col-md-2">
                        <a href="{{ route('dashboardArtikelCreate') }}" class="btn btn-primary">Tambah</a>
                    </div>
                </div>
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu">
                                            <a class="dropdown-item"
                                                href="{{ route('dashboardArtikelEdit', [$a->id]) }}"><i
                                                    class="bx bx-edit-alt me-1"></i> Edit</a>
                                            <a class="dropdown-item" href="{{ route('dashboardArtikelDel', [$a->id]) }}"><i
