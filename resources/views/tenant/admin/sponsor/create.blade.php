...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Dashboard / <a class="text-muted fw-light"
                    href="{{ route('dashboardSponsor') }}">Sponsor /</a> </span> Create Sponsor </h4>
        <div class="card mb-4">
            <h5 class="card-header">Tambahkan Sponsor</h5>
            <form action="{{ route('dashboardSponsorAdd') }}" method="POST" enctype="multipart/form-data" class="card-body">
                @csrf
                <div class="mb-3">
                ...
                <div class="mb-3">
                    <label for="formFile" class="form-label">Gambar Sponsor</label>
